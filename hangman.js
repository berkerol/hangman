...
col.appendChild(createTextRow('row', 'form-group', [['Guess', 'guess']]));
col.appendChild(createButtonGroupRow('row', 'btn-group', [['success', 'if(!locked)window.guess()', 'g', 'search', '<u>G</u>uess'], ['primary', 'if(!locked)random()', 'r', 'random', '<u>R</u>andom']]));
col.appendChild(createButtonGroupRow('row', 'btn-group mt-4', [['danger', 'if(!locked)giveUp()', 'u', 'times', 'Give <u>U</u>p'], ['info', 'restart()', 'e', 'sync', 'R<u>e</u>start']]));
col.appendChild(createCheckboxRow('row', 'form-group mt-4', [['<u>D</u>elete name after round', 'del', 'd']]));
resetInputs();
restart();
